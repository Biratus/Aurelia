...
Phaser.Plugin.PhaserIlluminated.prototype._createPolygonObject = function(data,diffuse){
    var vec2Data = [];
    ...
    var obj = new illuminated.PolygonObject({points: vec2Data,diffuse:diffuse});
